...
const Science: React.FunctionComponent<React.SVGAttributes<SVGElement>> = () => (
  <svg viewBox='0 0 636.7 227.3' fill='currentColor'>
...
export const Footer = () => (
  <footer className='mx-auto flex max-w-screen-xl flex-col flex-nowrap gap-4 px-4 font-light md:flex-row md:flex-wrap'>
    <hr className='flex-[1_1_100%] border-[#202020]' />
    <div className='flex grow-[2] flex-col flex-nowrap'>
      <h3 className='my-4 text-xl font-normal'>General</h3>
      <p className='text-base text-stone-400'>The website of Vagabond Hiatus Chart.</p>
      <p className='text-base text-stone-400'>Some of the images belongs to Takehiko Inoue &amp; Kōdansha.</p>
      <p className='text-base text-stone-400'>For a better experience visit the site on desktop mode.</p>
      <div className='my-4 min-w-[200px] max-w-[200px]'>
        <Science />
      </div>
    </div>
    <div className='flex grow flex-col flex-nowrap'>
      <h3 className='my-4 text-xl font-normal'>Navigation</h3>
      <Link className='w-max text-teal-400 hover:opacity-90' href='/'>
        Home
      </Link>
      <Link className='w-max text-teal-400 hover:opacity-90' href='/about'>
        About
      </Link>
    </div>
    <div className='flex grow flex-col flex-nowrap'>
      ...
      <a
        className='w-max text-teal-400 hover:opacity-90'
    ...
    <p className='mb-4 w-full text-center leading-loose'>Vagabond Hiatus Chart © 2021 - Present.</p>
  </footer>
);
