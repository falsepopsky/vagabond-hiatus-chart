...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang='en' suppressHydrationWarning className={ibm_plex_sans.className}>
      ...
      bg-slate-100 text-zinc-800 selection:bg-neutral-900 selection:text-neutral-300 dark:bg-neutral-950 dark:text-neutral-300 dark:selection:bg-neutral-300 dark:selection:text-neutral-900'>
        <Theme attribute='class'>
          ...
          <footer className='mx-auto flex w-full max-w-screen-xl flex-col flex-nowrap gap-4 px-4 font-light md:flex-row md:flex-wrap xl:px-2'>
            <hr className='flex-[1_1_100%] dark:border-zinc-900' />
            <div className='flex grow-[2] flex-col flex-nowrap font-normal'>
              <h3 className='my-4 text-xl'>General</h3>
              <p className='mb-2 text-sm dark:text-neutral-400'>The website of Vagabond Hiatus Chart.</p>
              <p className='mb-2 text-sm dark:text-neutral-400'>
                Some of the images belongs to Takehiko Inoue &amp; Kōdansha.
              </p>
              <p className='mb-2 text-sm dark:text-neutral-400'>
                For a better experience, visit the site in desktop mode.
              </p>
            ...
            <div className='flex grow flex-col flex-nowrap'>
              ...
              <Link className='mb-2 w-max text-sm text-teal-700 hover:opacity-90 dark:text-teal-400' href='/'>
                Home
              </Link>
              <Link className='mb-2 w-max text-sm text-teal-700 hover:opacity-90 dark:text-teal-400' href='/about'>
                About
              </Link>
            </div>
            <div className='flex grow flex-col flex-nowrap'>
              ...
              <a
                className='mb-2 w-max text-sm text-teal-700 hover:opacity-90 dark:text-teal-400'
            ...
            <p className='mb-4 w-full text-center text-base leading-loose dark:text-stone-400'>
